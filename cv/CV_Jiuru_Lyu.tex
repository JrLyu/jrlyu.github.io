...
\address{+1 (404)-791-0290 \\ \href{mailto:jiuru.lyu@emory.edu}{jiuru.lyu@emory.edu} \\ \href{https://github.com/JrLyu}{GitHub} \\ \href{https://www.linkedin.com/in/jiuru-lyu/}{LinkedIn} \\ \href{https://jrlyu.github.io/}{Personal Website}}
...
\begin{list}{$\bullet$}{\leftmargin=1em}
   \itemsep -0.5em
\item \textbf{\href{https://mathematics.emory.edu/undergraduate/awards.html\#row2}{Trevor Evans Award}}\hfill{May 2025}\\\textit{Department of Mathematics, Emory University}\hfill\textit{Atlanta, GA}
...
\item \textbf{\href{https://mathematics.emory.edu/undergraduate/awards.html\#row1}{Wilson Family Undergraduate Research Award}}\hfill{May 2025}\\
...
\begin{rSection}{Manuscripts and Publications}
{\bf\large Theses}
\begin{enumerate}
\renewcommand{\labelenumi}{[T\arabic{enumi}]}
\setlength{\itemsep}{-0.5em}
	\item \textbf{Lyu, Jiuru}. \href{https://etd.library.emory.edu/concern/etds/1g05fd258?locale=en}{\textit{Double Descent and Color Intermittent Diffusion: A Global Optimization Framework Across Disciplines}}. Bachelor's Honors Thesis, Emory University, 2026. Emory Theses and Dissertations.
\end{enumerate}
\end{rSection}
