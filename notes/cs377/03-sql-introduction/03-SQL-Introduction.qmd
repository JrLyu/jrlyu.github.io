...
description: "This note introduces SQL, the Structured Query Language, which is used to interact with databases. We will cover basic queries, the use of `*`, `AS`, conditions, and `ORDER BY` in SQL."
author:
  - name: Jiuru Lyu
    url: https://jrlyu.github.io/
date: 09-10-2024
categories: [Coding, SQL, Database]
draft: false
---
...
:::{#tip-basic-queries .callout-tip collapse="true"}
## Example: Link SQL and RA
```sql
SELECT name
FROM Course
WHERE dept = 'CSC';
...
## Example: `,` is the Cartesian Product
```sql
SELECT name
...
:::{#tip-renaming .callout-tip collapse="true"}
## Example: Renaming
```sql
...
:::{#tip-self-join .callout-tip collapse="true"}
##  Example: Self-Joins
...
:::{#tip-select-all .callout-tip collapse="true"}
## Example: Using `*`
```sql
SELECT *
FROM Course
...
:::{#tip-rename-attribute .callout-tip collapse="true"}
...
:::{#tip-conditions .callout-tip collapse="true"}
## Example: Conditions
```sql
SELECT *
FROM Offering
...
:::{#tip-order-by .callout-tip collapse="true"}
...
:::{#tip-expression-select .callout-tip collapse="true"}
## Example: Expressions in `SELECT` Clauses
...
:::{#tip-constant-expression .callout-tip collapse="true"}
